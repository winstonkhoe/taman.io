...
@section('content')
    <div class="w-100 position-relative" style="min-height: calc(100vh - 4rem)">
        ...
        <div class="card position-absolute login-wrapper">
            ...
            <div class="w-100 h-100 mx-auto d-flex flex-column items-center justify-center justify-content-around py-4">
                <h3 class="header">LOGIN</h3>
                {{-- <img class="w-auto mb-4" src={{asset('/assets/logo_full.png')}} alt="" style="object-fit: contain; object-position: center; width: 20%"> --}}
                <div class="w-100 h-75 d-flex flex-column items-center" style="height: 75%">
                    <div class="w-75 py-3 login-input mb-3" >
                        <div class="h-100 w-100 px-3 d-flex items-center" >
                    ...
                    <div class="w-75 py-3 login-input mb-1" >
                        <div class="h-100 w-100 px-3 d-flex items-center" >
                            <svg class="h-5 w-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="#FFF" aria-hidden="true">
                                <path fill-rule="evenodd" d="M5 9V7a5 5 0 0110 0v2a2 2 0 012 2v5a2 2 0 01-2 2H5a2 2 0 01-2-2v-5a2 2 0 012-2zm8-2v2H7V7a3 3 0 016 0z" clip-rule="evenodd" />
                            </svg>
                            <input class="w-100 px-2" type="password" name="password" id="" placeholder="Password">
                        </div>
                    </div>
                    <div class="w-75 d-flex justify-between mb-5 px-3">
                        <div class="d-flex items-center">
                            <input type="checkbox" name="" id="">
                            <span class="ml-2 hyperlink">Remember Me</span>
                        </div>
                        <a class="hyperlink" href="/register">Create Account</a>
                    </div>
                    <button class="login-btn py-2" style="width: 30%">LOGIN</button>
                </div>
            </div>
        </div>
    </div>
