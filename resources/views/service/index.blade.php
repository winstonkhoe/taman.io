    ...
    <div class="container-fluid d-flex flex-column px-5 background min-vh-100 pt-5" style="">
        ...
        {{-- <div class="row mb-5"> --}}
            <div class="w-50" style="height: 300px">
                <img class="w-100 h-100 br-card" src=@if($data->image){{Storage::url("/uploads/".$data->image->filename)}} @else {{asset("assets/no_image.webp")}} @endif alt="Service" style="@if($data->image) object-fit: cover; @else object-fit:contain;  @endif object-position: center">
            </div>
                    ...
                    <div class="d-flex flex-column p-3">
                        ...
                        @else
                            ...
                            <div class="d-flex w-100 justify-content-between">
                                ...
                                <h6 id="final-price" class="header" style="font-size: 1.3rem; font-weight: 700;">Rp {{number_format($data->price)}}</h6>
                            </div>
