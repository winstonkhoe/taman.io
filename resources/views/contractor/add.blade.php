                ...
                <div class="py-5">
                    ...
                    <div class="w-100 d-flex flex-column align-items-center justify-content-center mt-5">
                        <label class="position-relative" for="file">
                            <img id="profile-image" class="rounded-3"
                                style="width: 400px; height: 300px; object-fit: cover; cursor: pointer"
                                src=@if ($data->image) {{ Storage::url('public/uploads/' . $data->image->filename) }}
                        @else
                            {{ asset('assets/no_image.webp') }} @endif
                                alt="profile">
                ...
                <div class="d-flex w-100 flex-column">
                    <div class="mt-3 d-flex flex-column">
                        ...
                        <div class="input-box d-flex">
                            <input id="" name="price" type="number" value="" class="flex-fill"
                                placeholder="50000">
                        </div>
                    </div>
                </div>
