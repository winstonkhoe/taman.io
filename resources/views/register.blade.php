...
@section('content')
    <div class="w-100 position-relative" style="min-height: calc(100vh - 4rem)">
        <img class="w-100 h-100 img-fluid position-absolute top-0 left-0" style="object-fit: cover; height: calc(100% - 4rem); opacity: 0.6;" src={{asset('/assets/login-bg-2.jpg')}} alt="tanam.io">
        <div class="card position-absolute login-wrapper">
            ...
            <div class="w-100 h-100 mx-auto flex flex-col items-center">
                ...
                <form class="w-100 h-100" action="" method="POST" enctype="multipart/form-data">
                    {{csrf_field()}}
                <div class="w-100 h-75 flex flex-col items-center" style="height: 75%">
                    <h3 class="m-0 my-3 header">REGISTER</h3>
                    {{-- <div class="w-75 pl-3">
                    <label for="email">Email</label>
                    </div> --}}
                    <div class="w-75 py-2 login-input mb-2" >
                        <div class="h-100 w-100 px-3 flex items-center" >
                            <div class="icon-input flex items-center">
                    ...
                    <div class="w-75 py-2 login-input mb-1" >
                        <div class="h-100 w-100 px-3 flex items-center" >
                            ...
                            <textarea class="w-100 register-textarea px-2" name="address" id="" placeholder="Type your address.." style="height: 50px"></textarea>
                        </div>
                    </div>
                    <div class="w-75 flex justify-between mb-2 px-3">
                        <a class="hyperlink" href="/login">Already have an account?</a>
                    </div>
                    <div class="w-75 flex items-center justify-center text-red-700 mb-2">
                        @if ($errors->all())
                        <p class="m-0">
                            {{$errors->all()[0]}}
                        </p>
