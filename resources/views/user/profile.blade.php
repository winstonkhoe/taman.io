        ...
        <div class="max-w-md w-100">
            <div class="py-5">
                ...
                {{-- <div class="w-100 d-flex justify-content-center mt-5">
                    <img id="profile-image" class="" style="width: 200px; height: 200px; object-fit: cover; border-radius: 50%;" src={{Storage::url("public/uploads/".auth()->user()->image)}} alt="profile">
                </div> --}}
                <div class="w-100 d-flex flex-column align-items-center justify-content-center mt-5">
                    ...
                    <label class="position-relative" for="file">
                        <img id="profile-image" class=""
                            ...
                            src=@if (auth()->user()->artist->image) {{ Storage::url('public/uploads/' . auth()->user()->image) }}
                        @else
                ...
                <div class="d-flex w-100 flex-column">
                    <div class="mt-3 d-flex flex-column">
                        ...
                        <div class="input-box d-flex">
                            <input id="name" name="name" type="name" value="{{ auth()->user()->name }}" required
                                class="flex-fill" placeholder="Name">
                        </div>
                    </div>
                    <div class="mt-3 d-flex flex-column">
                        <label for="email-address">Email address</label>
                        <div class="input-box d-flex">
                            <input id="email-address" name="email" type="email" value="{{ auth()->user()->email }}"
                                class="flex-fill" placeholder="Email address">
                        </div>
                    </div>
                    ...
                    <div class="mt-3 d-flex flex-column">
                        ...
                        <div class="input-box d-flex">
                            <input id="address" name="address" type="text" value="{{ auth()->user()->address }}"
                                required class="flex-fill" placeholder="Type your address here...">
                        </div>
                    </div>
                    <div class="mt-3 d-flex flex-column">
                        <label for="phone">Phone Number</label>
                        <div class="input-box d-flex">
                            <input id="phone" name="phone" type="text" value="{{ auth()->user()->phone }}" required
                                class="flex-fill" placeholder="Phone Number">
                        </div>
                    </div>
